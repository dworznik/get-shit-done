...
const VALID_CONFIG_KEYS = new Set([
  ...
  'workflow.codex_supervisor',
  'workflow.codex_supervisor_phase',
  'workflow.codex_supervisor_transport',
  'workflow.codex_launch_command',
  'workflow.codex_boot_delay_ms',
  'workflow.codex_supervisor_timeout_seconds',
  'workflow.codex_supervisor_poll_ms',
  'workflow.codex_keep_window_on_failure',
  'workflow.codex_keep_window_on_success',
