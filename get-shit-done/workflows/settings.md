...
AskUserQuestion([
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Per Phase", description: "Create branch for each phase (feature/phase-{N}-{name})" },
      { label: "Per Milestone", description: "Create branch for entire milestone (feature/{version}-{name})" }
    ]
  },
  {
